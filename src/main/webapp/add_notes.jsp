    ...
    <div class="container">
      ...
      <form action="SaveNoteServlet" method="post">
		  <div class="form-group">
		    ...
		    <input name="title" type="text" class="form-control"   placeholder="Please Enter Your Title" required/>
	      ...
	      <button type="submit" onclick="add()" class="btn btn-primary">Add</button><span id="h"></span>
	      </div>
      </form>
    </div>
