	  ...
	  <div class="col-md-6 offset-md-3">
		<div class="card mt-3">
			...
			<div class="card-header purple ">
			    <div class="container text-center">	<h1 class="text-white">This is a Sign Up page</h1></div>
			</div>
			...
			<form class="px-4 py-3" action="Signup" method="post">
				...
				<div class="form-group">
					<label for="login">Login Id</label> <input type="text"
						class="form-control" name="loginid" id="exampleDropdownFormEmail1"
						placeholder="Login Id Enter Here">
				</div>
				<div class="form-group">
